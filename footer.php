	<footer id="footer">
				<div class="flex">
					<div>
						<dl>
							<dt class="bold"><a href="<?php echo home_url(); ?>/shop/">SHOP</a></dt>
							<dd><a href="<?php echo home_url(); ?>/shop/#miyagi">宮城県</a></dd>
							<dd><a href="<?php echo home_url(); ?>/shop/#yamagata">山形県</a></dd>
							<dd><a href="<?php echo home_url(); ?>/shop/#nigata">新潟県</a></dd>
							<dd><a href="<?php echo home_url(); ?>/shop/#toyama">富山県</a></dd>
							<dd><a href="<?php echo home_url(); ?>/shop/#ishikawa">石川県</a></dd>
							<dd><a href="<?php echo home_url(); ?>/shop/#fukui">福井県</a></dd>
							<dd><a href="<?php echo home_url(); ?>/shop/#nagano">長野県</a></dd>
							<dd><a href="<?php echo home_url(); ?>/shop/#kyoto">京都府</a></dd>
							<dd><a href="<?php echo home_url(); ?>/shop/#osaka">大阪府</a></dd>
							<dd><a href="<?php echo home_url(); ?>/shop/#hyogo">兵庫県</a></dd>
						</dl>
					</div>
					<div>
						<dl>
							...
							<dd><a href="<?php echo home_url(); ?>/guide/yohin/">家庭用品・日用品</a></dd>
							<dd><a href="<?php echo home_url(); ?>/guide/kaden/">家電・照明</a></dd>
							<dd><a href="<?php echo home_url(); ?>/guide/garden/">ガーデンセンター</a></dd>
							<dd><a href="<?php echo home_url(); ?>/guide/pet/">ペットセンター</a></dd>
							<dd><a href="<?php echo home_url(); ?>/guide/pro/">ムサシプロ</a></dd>
							<dd><a href="<?php echo home_url(); ?>/guide/sm/">ムサシ食品館</a></dd>
						</dl>
					</div>
					<div>
						<dl>
							...
							<dd><a href="<?php echo home_url(); ?>/guide/pro/">ムサシプロ／住DEPOT</a></dd>
